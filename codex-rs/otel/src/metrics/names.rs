...
pub const API_REQUEST_BYTES_WRITTEN_METRIC: &str = "codex.api_request.bytes_written";
pub const API_RESPONSE_BYTES_READ_METRIC: &str = "codex.api_response.bytes_read";
pub const SSE_EVENT_COUNT_METRIC: &str = "codex.sse_event";
pub const SSE_EVENT_DURATION_METRIC: &str = "codex.sse_event.duration_ms";
pub const SSE_BYTES_READ_METRIC: &str = "codex.sse.bytes_read";
